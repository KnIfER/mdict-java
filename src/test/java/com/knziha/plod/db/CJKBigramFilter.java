...
//			}
			...
			if (end != java.text.BreakIterator.DONE) {
				sb.getChars(start, end, termAtt.buffer(), 0);
...
//			for (Object t:terms)
//				CMN.Log("incrementToken::termAtt", t);
			CMN.Log("incrementToken::termAtt", sb);
			return false;
		}
		while (true) {
